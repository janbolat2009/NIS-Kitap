<template>
  <div class="fantastica">
    ...
    <div class="books">
      <h2 class="books-h2">Книги жанра Приключения</h2>
...
export default {
  ...
  methods: {
    async fetchBooks() {
      try {
        const response = await axios.get('http://localhost:3000/books/genre/Приключения');
        this.books = response.data;
        console.log('Книги жанра Приключения загружены:', this.books);
      } catch (error) {
