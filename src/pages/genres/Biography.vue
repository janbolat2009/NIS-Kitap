<template>
  <div class="fantastica">
    ...
    <div class="books">
      <h2 class="books-h2">Книги жанра Биография</h2>
...
export default {
  ...
  methods: {
    async fetchBooks() {
      try {
        const response = await axios.get('http://localhost:3000/books/genre/Биография');
        this.books = response.data;
        console.log('Книги жанра Биография загружены:', this.books);
      } catch (error) {
