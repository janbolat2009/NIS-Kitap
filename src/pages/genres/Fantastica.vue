<template>
  <div class="fantastica">
    ...
    <div class="books">
      <h2 class="books-h2">Книги жанра Фантастика</h2>
...
export default {
  ...
  methods: {
    async fetchBooks() {
      try {
        const response = await axios.get('http://localhost:3000/books/genre/Фантастика');
        this.books = response.data;
        console.log('Книги жанра Фантастика загружены:', this.books);
      } catch (error) {
