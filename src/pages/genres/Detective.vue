<template>
  <div class="fantastica">
    ...
    <div class="books">
      <h2 class="books-h2">Книги жанра Детектив</h2>
...
export default {
  ...
  methods: {
    async fetchBooks() {
      try {
        const response = await axios.get('http://localhost:3000/books/genre/Детектив');
        this.books = response.data;
        console.log('Книги жанра Детектив загружены:', this.books);
      } catch (error) {
